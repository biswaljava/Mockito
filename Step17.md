...
```
### /src/main/java/com/biswaljava/junit/business/ClientBO.java
```
...
```
### /src/main/java/com/biswaljava/junit/business/ClientBOImpl.java
```
package com.biswaljava.junit.business;
...
```
### /src/main/java/com/biswaljava/junit/business/exception/DifferentCurrenciesException.java
```
package com.biswaljava.junit.business.exception;
...
```
### /src/main/java/com/biswaljava/junit/helper/StringHelper.java
```
package com.biswaljava.junit.helper;
...
```
### /src/main/java/com/biswaljava/junit/model/Amount.java
```
...
```
### /src/main/java/com/biswaljava/junit/model/AmountImpl.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/Client.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/ClientImpl.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/ClientType.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/Collateral.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/CollateralImpl.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/CollateralType.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/Currency.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/Product.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/ProductImpl.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/junit/model/ProductType.java
```
package com.biswaljava.junit.model;
...
```
### /src/main/java/com/biswaljava/powermock/SystemUnderTest.java
```
package com.biswaljava.powermock;
...
```
### /src/main/java/com/biswaljava/powermock/UtilityClass.java
```
package com.biswaljava.powermock;
...
```
### /src/test/java/com/biswaljava/business/TodoBusinessImplMockitoInjectMocksTest.java
```
package com.biswaljava.business;
...
```
### /src/test/java/com/biswaljava/business/TodoBusinessImplMockitoRulesTest.java
```
package com.biswaljava.business;
...
```
### /src/test/java/com/biswaljava/junit/helper/ArraysCompareTest.java
```
package com.biswaljava.junit.helper;
...
```
### /src/test/java/com/biswaljava/junit/helper/ArraysTest.java
```
package com.biswaljava.junit.helper;
...
```
### /src/test/java/com/biswaljava/junit/helper/QuickBeforeAfterTest.java
```
package com.biswaljava.junit.helper;
...
```
### /src/test/java/com/biswaljava/junit/helper/StringHelperParameterizedTest.java
```
package com.biswaljava.junit.helper;
...
```
### /src/test/java/com/biswaljava/junit/helper/StringHelperTest.java
```
package com.biswaljava.junit.helper;
...
```
### /src/test/java/com/biswaljava/junit/suite/DummyTestSuite.java
```
...
```
### /src/test/java/com/biswaljava/mockito/HamcrestMatcherTest.java
```
package com.biswaljava.mockito;
...
public class ListTest {
	...
	public void letsMockListGet() {
		...
		when(list.get(0)).thenReturn("biswaljava");
	...
	public void bddAliases_UsingGivenWillReturn() {
		...
		//given
		given(list.get(Mockito.anyInt())).willReturn("biswaljava");

		//then
		assertThat("biswaljava", is(list.get(0)));
		assertThat("biswaljava", is(list.get(0)));
	}
}
```
### /src/test/java/com/biswaljava/mockito/SpyTest.java
```
package com.biswaljava.mockito;
...
```
### /src/test/java/com/biswaljava/powermock/PowerMockitoMockingConstructorTest.java
```
package com.biswaljava.powermock;
...
```
### /src/test/java/com/biswaljava/powermock/PowerMockitoMockingStaticMethodTest.java
```
package com.biswaljava.powermock;
...
```
### /src/test/java/com/biswaljava/powermock/PowerMockitoTestingPrivateMethodTest.java
```
package com.biswaljava.powermock;
